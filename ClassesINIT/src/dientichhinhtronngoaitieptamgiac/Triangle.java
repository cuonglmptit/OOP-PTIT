...
public class Triangle {
    ...
    private double a, b, c, radiusOfOutterCircle;
    public Triangle(Point p1, Point p2, Point p3) throws KhongTheTaoTamGiacException{
        ...
        if(a == 0||b == 0|| c == 0) throw new KhongTheTaoTamGiacException("INVALID");
            ...
            this.p2 = p2;
            this.p3 = p3;
            this.radiusOfOutterCircle = (a*b*c)/(4*this.triArea());
        }
    }
    ...
    public double areaOfOutterCircleOfTri(){
        return (Math.PI)*(this.radiusOfOutterCircle)*(this.radiusOfOutterCircle);
    }
}
