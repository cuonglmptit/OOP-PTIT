...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        LichGiangDay.setListMon(tentheoma);
        String giangvien = lich.nextLine();
        System.out.println("LICH GIANG DAY GIANG VIEN "+giangvien+":");
        for (LichGiangDay lichGiangDay : dslgd) {
            if(lichGiangDay.getHoTenGV().equals(giangvien)){
